    ...
    <>
      <Dialog open={isOpen} onClose={onClose} className="relative z-50">
        ...
        <div className="fixed inset-0 flex items-center justify-center p-3">
          <DialogPanel className="bg-white dark:bg-gray-800 p-5 rounded-lg shadow-xl max-w-[600px] text-gray-800 dark:text-white">
            {/* Header */}
            <div className="flex justify-between items-center">
              ...
              <button
                onClick={onClose}
                className="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300 text-xl cursor-pointer"
                disabled={isLoading}
              >
                <X />
              </button>
            ...
            {/* Description */}
            <Description className="text-sm text-gray-600 dark:text-gray-400 mb-6">
            ...
            <div className="flex justify-between items-start mb-6 gap-7">
              ...
              <div className="flex items-center gap-4">
                ...
                />
                <div>
                  <h2 className="text-md font-semibold text-gray-800 dark:text-white">{trainer.name}</h2>
                  <p className="text-sm text-gray-600 dark:text-gray-400">{trainer.title}</p>
            ...
            <button
              ...
              disabled={isLoading}
              className={`w-full py-2 ${isLoading ? 'bg-gray-300 dark:bg-gray-600' : 'bg-lime-500 hover:bg-lime-400 dark:bg-lime-600 dark:hover:bg-lime-500'} text-black dark:text-white font-medium rounded-md transition cursor-pointer`}
            >
